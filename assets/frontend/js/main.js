$(document).ready(function () {
	...
	$(window).on('scroll', function () {
		...
		if ($(window).scrollTop() > 200) {
			...
			// $('#logonya').src="kwaowak";
			document.getElementById("logonya").src = "http://spampasigala.com/assets/frontend/images/logo2.png";
		} else {
			menu_area.removeClass('sticky_navigation');
			document.getElementById("logonya").src = "http://spampasigala.com/assets/frontend/images/logo.png";
